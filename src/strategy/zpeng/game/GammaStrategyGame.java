...
import static strategy.StrategyGame.Version.GAMMA;
 ...
 * @version Mar 18, 2019
 */
public class GammaStrategyGame extends BaseGame
{
	/**
	 * Constructor
	 * @param board of game
	...
	public MoveResult move(int fr, int fc, int tr, int tc)	{
		...
		if(this.myBoard.getPieceAt(tr, tc) == null) {
			...
			moveResult = super.checkStrikeValidity(this.myBoard, fr, fc, tr, tc, GAMMA);
		}
