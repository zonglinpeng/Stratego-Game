...
import static strategy.StrategyGame.Version.EPSILON;
 ...
 * @version Mar 18, 2019
 */
public class EpsilonStrategyGame extends BaseGame
{
	...
	public MoveResult move(int fr, int fc, int tr, int tc)	{
		...
		if(this.myBoard.getPieceAt(tr, tc) == null) {
			...
			moveResult = super.checkStrikeValidity(this.myBoard, fr, fc, tr, tc, EPSILON);
		}
		
		// POSTGAME
		postgameResult = super.checkPostGameState(fr, fc, tr, tc, EPSILON);
